...
const Box = () => {
    return (
        <>
            <section
                className="h-full p-5 md:p-11 gap-8 text-white bg-gray-200 flex flex-col md:flex-row items-center justify-around"
            >
                <div
                    className="h-[300px] md:h-[430px] w-full md:w-[496px] rounded-md flex flex-col justify-end space-y-4 p-5 md:p-8 text-white bg-gray-800"
                >
                    <div>
                    ...
                    <div className='space-y-4'>
                        ...
                        <button className='rounded px-8 md:px-12 py-3 bg-[#EA001E]'>Schedule a test drive</button>
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    <div className='space-y-4'>
                        ...
                        <button className='rounded px-8 md:px-12 py-3 bg-[#EA001E]'>View our Inventory</button>
                    </div>
                </div>
            </section>
        </>
