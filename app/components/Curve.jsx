...
const Curve = () => {
    return (
        <>
            <section className='h-full text-black p-14 space-y-5'>
                <div className="space-y-5 px-52 text-center">
                    <h1 className='text-4xl text-center font-semibold'>Capital Car <span className="text-[#EA001E]">Features</span></h1>
