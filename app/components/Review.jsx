...
const Review = () => {
    return (
        <>
            ...
            <section className='h-screen bg-gray-100 p-11 space-y-8'>
                ...
                <section className='flex justify-between'>
                    <div className='w-[545px] h-[270px] border rounded-t-lg'>
                        ...
                        <p className='p-8'>I had an amazing experience with this service! The team was professional, attentive, and truly cared about my needs. I would highly recommend them to anyone looking for quality and reliability.</p>
                    </div>
                    <div className='w-[545px] h-[270px] border rounded-t-lg'>
                        <div className='bg-[#878585] flex gap-9 p-4 rounded-t-lg'>
                            <img src="testimonial-3.jpg" className='rounded-full' alt="" />
