    ...
    return (
        <>
            <section className='h-full p-5 md:p-11 space-y-12'> {/* Adjusted padding for responsiveness */}
                <div>
                    <h1 className='text-4xl md:text-5xl text-center'>Our Services</h1> {/* Responsive font size */}
                </div>
                <section className='flex flex-col md:flex-row justify-between items-center text-center h-full gap-8 md:gap-12'> {/* Adjusted layout for responsiveness */}
